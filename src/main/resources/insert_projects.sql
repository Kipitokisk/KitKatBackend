...
INSERT INTO t_projects (project_id, project_name, start_date, finish_date, manager_id, status, description) VALUES (1, 'Kitkat', '2024-01-01T00:00:00', null, 2, true, 'Snack that should be snapped vertically not horizontally');
